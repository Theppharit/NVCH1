...
const scrollHeader = () => {
  ...
  // Add a class if the buttom offset is greater than 50 of the viewport
  this.scrollY >= 50
...
const scrollUp = () => {
  ...
  // When the scroll is higher than 350 viewport hieght, add the show-scroll class to the a tag with the scrollup class
  this.scrollY >= 350
...
sr.reveal('.service__card, .service__title, .sevice__description', {interval: 100})
